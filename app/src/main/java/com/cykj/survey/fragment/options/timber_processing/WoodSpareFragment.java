 ...
 * 木材加工企业-库存区-备品备件库
 */
public class WoodSpareFragment extends BaseFragment {
    ...
    private void initData() {
        ...
        options.add(getString(R.string.wood_spare_options_1));
        options.add(getString(R.string.wood_spare_options_2));
    }
